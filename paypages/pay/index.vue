...
export default {
    ...
    methods: {
        selectDataBasedOnShopId() {
            if (this.shopId >= 1 && this.shopId <= 4) {
            ...
            } else if (this.shopId >= 5 && this.shopId <= 9) {
                ...
                console.log("shopId不在预期内");
                // 处理shopId为10的情况或不符合任何条件的情况
                this.selectedData = [];
            }
        },
                ...
                success: async (res) => {
                    if (res.confirm) {
                        ...
                        const newOrder = {
                            ...
                            shopName: this.selectedData.name,
                            ...
                            orderContent: this.selectedData.name + "测试商品",
                            status: "交易完成",
                            shopImage: this.selectedData.image,
                            remark: this.remarkText,
                            orderimg: this.selectedData.image,
                            paymentMethod: "微信支付",
                            tradeNo: "123456789",
