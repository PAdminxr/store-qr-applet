<template>
    <view class="food-guide-page">
        <!-- 头部区域 -->
        <view class="header">
            <image src="/static/izaolife/header-bg.png" mode="aspectFill" class="header-image"></image>
            <!-- 搜索栏 -->
                ...
                <view class="food-item">
                    ...
                    <view class="food-top-badge">
                        ...
                        <view v-else class="top-badge2">
                            <image src="/static/izaolife/矩形.png" mode="aspectFit" class="top-tagimage">
                            </image>
...
export default {
    data() {
        return {
            foods: [
                { image: '/static/izaolife/swfood1.png', name: '枣庄特色辣子鸡', top: '01' },
                { image: '/static/izaolife/swfood2.png', name: '枣庄菜煎饼', top: '02' },
                { image: '/static/izaolife/swfood3.png', name: '滕州卷饼', top: '03' },
                { image: '/static/izaolife/swfood4.png', name: '枣庄糁汤', top: '04' },
                { image: '/static/izaolife/swfood5.png', name: '水煎包', top: '05' },
                { image: '/static/izaolife/swfood6.png', name: '羊肉汤', top: '06' }
            ]
        };
    },
    methods: {
