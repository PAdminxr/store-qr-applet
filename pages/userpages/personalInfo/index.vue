<template>
    <view class="container">
        <view class="user-info">
            <uni-list>
                <uni-list-item title="头像" link="navigateTo" :to="'/pages/userpages/personalInfo/avatar'">
                    <template #footer>
                ...
                <uni-list-item title="昵称" :rightText="userInfo.nickName" link="navigateTo"
                    :to="'/pages/userpages/personalInfo/editNickname'"></uni-list-item>
                <uni-list-item title="简介" :rightText="userInfo.introduction" link="navigateTo"
                    :to="'/pages/userpages/personalInfo/editIntroduction'"></uni-list-item>
